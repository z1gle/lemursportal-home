...
public interface UtilisateurRepository extends
    ...
    @Query(value = "select expert.id,expert.photo_profil,expert.nom,expert.prenoms,expert.titre from (select u.*,a.genre,a.famille,a.espece\n"
            ...
            + "where expert.genre like '%' || :keyword || '%' or expert.famille like '%' || :keyword || '%' or expert.espece like '%' || :keyword || '%' \n"
            + "or concat(expert.nom,' ',expert.prenoms) like '%' || :keyword || '%' or concat(expert.prenoms,' ',expert.nom) like '%' || :keyword || '%' or expert.biographie like '%' || :keyword || '%' \n"
            + "or expert.publication like '%' || :keyword || '%' group by expert.id,expert.photo_profil,expert.nom,expert.prenoms,expert.titre limit 2", nativeQuery = true)
    ...
    @Query(value = "select expert.id,expert.photo_profil,expert.nom,expert.prenoms,expert.titre from (select u.*,a.genre,a.famille,a.espece\n"
            ...
            + "where expert.genre like '%' || :keyword || '%' or expert.famille like '%' || :keyword || '%' or expert.espece like '%' || :keyword || '%' \n"
            + "or concat(expert.nom,' ',expert.prenoms) like '%' || :keyword || '%' or concat(expert.prenoms,' ',expert.nom) like '%' || :keyword || '%' or expert.biographie like '%' || :keyword || '%' \n"
            + "or expert.publication like '%' || :keyword || '%' group by expert.id,expert.photo_profil,expert.nom,expert.prenoms,expert.titre", nativeQuery = true)
